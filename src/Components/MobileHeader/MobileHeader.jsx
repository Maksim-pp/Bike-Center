...
import Basket from '../../assets/image/Group 248.png'
import Union from '../../assets/image/Union.png'
import Open from '../../assets/image/Open.png'
import Close from '../../assets/image/Close.png'
import ArrowLocation from '../../assets/image/ArrowLocationMobile.png'
...
function MobileHeader() {
    ...
    return (
        <div className={style.block}>
            {!details
                    ? <button className={style.open} onClick={ShowMenu}><img src={Open} alt="" /></button>
                    : <button className={style.close} onClick={ShowMenu}><img src={Close} alt="" /></button>
                }
                {details  && 
                    <div className={style.menu}>
                        <div className={style.block__location}>
                            <p>Ваш город</p>
                            <div>
                                <img src={ArrowLocation} alt="" />
                                <a href="#">Краснодар</a>
                            </div>
                        </div>
                        <div className={style.subMenu__button}>
                            <button onClick={ShowSubMenu} className={style.button}>Каталог</button>
                            <button onClick={ShowBrands} className={style.button}>Бренды</button>
                        </div>
                        {subMenu &&
            ...
            <div className={style.icon_menu} >
                <a href="#" >
                    <img src={Union} alt="" onClick={ShowSearch}/>
                </a>
                <a href="#">
                    <img src={Basket} alt="" />
                </a>
